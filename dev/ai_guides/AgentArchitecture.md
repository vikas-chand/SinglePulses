...
| every gate presentation | NR-36 PLAIN-LANGUAGE OPENER: four jargon-free sentences (WHAT I DID / WHAT I FOUND / WHAT I NEED FROM YOU / WHAT HAPPENS NEXT) before ANY technical content — no register numbers, no state codes, no acronyms in those lines; a presentation the PI cannot understand is a FAILED presentation (PI catch 2026-08-30: "everything has suddenly become a complicated language"); the PI always replies in plain words and translation into the machinery is the session's job | DEPLOYED (FreshSessionBoot §8, binding on all sessions) |
