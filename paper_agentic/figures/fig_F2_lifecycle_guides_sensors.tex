...
\begin{tikzpicture}[
  ...
  comp/.style={draw=codeline, rounded corners=1.5pt, fill=codefill, text width=44mm, align=left, inner sep=1.6pt, execute at begin node=\nohyph},
  infer/.style={draw=agentline, rounded corners=1.5pt, fill=agentfill, text width=44mm, align=left, inner sep=1.6pt, execute at begin node=\nohyph},
...
\node[infer, right=2mm of gs0] (sr0) {no sensor beyond the PI gate at this step (roster: ``no figures, no verifier'')};
...
% legend
\node[comp, anchor=north west, text width=26mm, align=center] (l1) at ($(bandp.south)+(-78mm,-4mm)$) {blue: code (computational)};
...
\node[gate, right=3mm of l2b] (l3) {PI};
