...
\node[guide, left=2mm of s0] (gl0) {GCNIntelligence.md (G1--G2); identity by trigger, never by name; zero-circular positive control (checklist)};
...
% legend
\node[comp, anchor=north west, text width=26mm, align=center] (l1) at ($(bandp.south)+(-70mm,-4mm)$) {grey: computational};
