...
\begin{tikzpicture}[
  ...
  box/.style={draw=black!35, line width=0.6pt, rounded corners=5pt, fill=white, text width=34mm, align=center, minimum height=9mm, execute at begin node=\nohyph},
  ...
  layer/.style={draw=black!35, line width=0.5pt, rounded corners=4pt, text width=28mm, align=center, font=\sffamily\scriptsize, inner sep=2pt, execute at begin node=\nohyph},
  arr/.style={-{Stealth[length=2.4mm,width=2mm,round]}, line width=1pt, black!55, rounded corners=6pt, line cap=round, line join=round},
...
\node[event, below=7mm of k, xshift=-42mm] (next) {\textbf{next burst}\\runs a better pipeline};
...
\node[box, text width=22mm, font=\sffamily\scriptsize, minimum height=6mm] (leg1) at ($(prior.south |- L4.north)+(0,3.4mm)$) {solid: DEPLOYED};   % +3.4 mm: Source Sans wraps the register box in 4 lines (was 5), lifting the bottom row; keeps >= 2.5 mm above the test box
