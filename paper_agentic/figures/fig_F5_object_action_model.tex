...
\node[obj, right=of sel] (blk) {\textbf{block}\\edges, significance; e.g.\ sha \texttt{f361\ldots} (bn110920546)};
...
\draw[linkc] (fit) -- node[lab, below=5mm, text width=16mm, align=center, font=\sffamily\tiny] {stored AIC; table sha PROPOSED} (prod);
