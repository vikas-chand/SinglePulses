...
\begin{tikzpicture}[
  ...
  obj/.style={draw=black!35, line width=0.6pt, rounded corners=5pt, fill=white, text width=20mm, align=center, minimum height=9mm, execute at begin node=\nohyph},
  objc/.style={obj, fill=codefill, draw=codeline, line width=0.8pt},
  objh/.style={obj, fill=humanfill, draw=humanline, line width=0.8pt},   % amber objects keep the 0.8 pt frame (style gate N2)
  act/.style={-{Stealth[length=2.2mm,width=1.8mm,round]}, line width=1pt, black!55, line cap=round, line join=round},
  actp/.style={act, dashed, black!45},
  acth/.style={act, humanline},
  link/.style={-{Stealth[length=1.8mm,width=1.4mm,round]}, line width=0.6pt, black!55, line cap=round, line join=round},
  linkc/.style={link, dashed},
  lab/.style={font=\sffamily\scriptsize, text=black!75, execute at begin node=\nohyph},
  role/.style={draw=black!35, line width=0.6pt, rounded corners=5pt, text width=24mm, align=center, font=\sffamily\scriptsize, inner sep=2pt, execute at begin node=\nohyph},
  roleh/.style={role, fill=humanfill, draw=humanline}, rolea/.style={role, fill=agentfill, draw=agentline, line width=0.3pt}, rolec/.style={role, fill=codefill, draw=codeline, line width=0.8pt}]
...
\node[objh, below=11mm of sel, text width=22mm] (stamp) {\textbf{approval stamp} \ensuremath{\blacklozenge}\\step, status, by, utc, feedback};
...
\draw[acth] ($(sel.north)+(-6mm,0)$) to[bend left=25] node[lab, above] {\textbf{approve} (stamp)} ($(sel.north)+(6mm,0)$);
