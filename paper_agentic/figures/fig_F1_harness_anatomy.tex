...
\begin{scope}[on background layer]
  ...
  \node[draw=agentline, thick, rounded corners=3pt, pattern=north east lines, pattern color=agentline!25, inner sep=0, fit=(repo)] {};
  ...
  \node[fill=white, draw=agentline, rounded corners=1pt, inner sep=1.5pt, font=\sffamily\scriptsize\bfseries, text=agentline!80!black,
        text width=31mm, align=left, execute at begin node=\nohyph, anchor=south west] at ($(repo.south west)+(1mm,0.6mm)$) {the repository layer: what makes the session a GRB analyst};
\end{scope}
