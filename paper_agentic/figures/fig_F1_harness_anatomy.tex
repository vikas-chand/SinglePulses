...
\begin{tikzpicture}[
  ...
  arr/.style={-{Stealth[length=2.4mm,width=2mm,round]}, line width=1pt, black!55, line cap=round, line join=round},   % no 'rounded corners': the loop stubs (0.7 mm) and the stamp stub (1.5 mm) are shorter than any useful radius (style gate 2026-09-03)
