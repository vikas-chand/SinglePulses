...
\node[code, below=2.5mm of hr] (tests) {test suite: 134 tests --- lessons-as-tests and schema checks over the products, id guards, compile checks};
\node[code, below=of tests] (audit) {fit-table auditor over every promoted table (25 of 106 bursts): argmin, rails, tie set, count triple};
