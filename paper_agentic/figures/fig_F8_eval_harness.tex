...
\node[event, below=1.2mm of l1.south west, anchor=north west, text width=12mm, font=\sffamily\scriptsize] (l3b) {grey: events};
\node[human, right=1.2mm of l3b, aspect=2.2, font=\sffamily\scriptsize\bfseries] (l4) {human};
\node[prop, right=1.2mm of l4, text width=16mm, font=\sffamily\scriptsize] (l5) {dashed: proposed};
\end{tikzpicture}
\end{document}
