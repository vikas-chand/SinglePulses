...
the object: blue by code, amber carrying a human identity, white the law
and documents; the roles band uses the same colours, green for the agent.
A diamond marks an object type with a JSON schema on disk. Links are solid where a declared field
