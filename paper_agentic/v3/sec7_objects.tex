...
\paragraph{Objects.} Twelve object types carry the campaign. Five form the
...
that fixes generators by commit and products by hash. Ten of the twelve
types\prov{} carry a JSON schema, and the test suite validates every
instance on disk against it. Schemas came late: the pipeline had written
