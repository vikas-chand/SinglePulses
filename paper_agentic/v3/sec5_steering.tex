...
five step skills hold forty-three heading-form numbered lessons\prov{} (the
literature-harvest skill carries eleven numbered traps in list form);
twenty-three of the forty-three are credited to the nine bursts walked so
...
walkthroughs, to campaign batches, to lessons the ledger rows omit, and to
rulings by the human. It is auditable: the learned policy is plain
