...
ninth is the walkthrough burst still in progress (review-index number 21),
credited with the lessons whose entries name it, its defects not yet
tallied. The order is walk order, not time. The curve is visibly
