# bn081222204 — reproduction record
...
|---|---|---|---|
| `41c_paper_sed.py` | `c3612e306c018586…` | `19cce0784fa403dd…` | **NO — script changed since render** |
...
```
python scripts/41c_paper_sed.py --trig bn081222204 --bin 0 --model BAND --out results/convention_check/sed_grid_bn081222204 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn081222204 --bin 0 --model BANDBB --out results/convention_check/sed_grid_bn081222204 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn081222204 --bin 0 --model BANDBBCPL --out results/convention_check/sed_grid_bn081222204 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn081222204 --bin 0 --model BANDBBPL --out results/convention_check/sed_grid_bn081222204 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn081222204 --bin 0 --model BANDCPL --out results/convention_check/sed_grid_bn081222204 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn081222204 --bin 0 --model BANDCUT --out results/convention_check/sed_grid_bn081222204 --fit-root results/convention_check
# … 162 more (one per model/bin panel; same form)
python3 scripts/41e_sed_montage.py --trig bn081222204
python dev/rebuild_step9_canonical.py --trig bn081222204
python3 dev/gen_param_tables.py --trig bn081222204
python scripts/10_spectral_fit_burst.py --trigger bn081222204 --include-bgo --no-log --models highe \
    --blocks-file results/sweep106/bn081222204/blocks/bb_blocks_spectral_bn081222204.ecsv \
    --bkg-file results/background_intervals.ecsv --out-dir results/campaign20_fam/bn081222204_highe
```
...
|---|---|---|---|---|
| n0 | (-29.87, -9.16) | (25.00, 105.00) | (-1.16, 16.48) | Vikas Chand |
| n1 | (-26.86, -4.86) | (25.14, 103.14) | (-1.16, 16.48) | Vikas Chand |
| n2 | (-29.87, -9.16) | (25.00, 105.00) | (-1.16, 16.48) | Vikas Chand |
| b0 | (-26.87, -6.87) | (20.13, 73.13) | (-1.16, 16.48) | Vikas Chand |

Block table: `results/sweep106/bn081222204/blocks/bb_blocks_spectral_bn081222204.ecsv`
- sha256 `0603d3f35f9fd00b…`
- reused unchanged from the 2026-08-12 binning run; re-deriving blocks
  per convention would break cross-burst comparability.

Canonical fit table: `results/convention_check/bn081222204/spectral_fits.ecsv`
- sha256 `26d49d70d596a14b…`; 24 models × 7 spectra
- canonicalization: best optimizer minimum per (bin, model) across
  all invocations we possess (multistart luck reaches ΔAIC ≈ 9).

## Notebook

`notebooks/Two_Breaks_single_GRB_pipeline.ipynb` (config `notebooks/configs/bn081222204.yaml`) runs the same chain interactively and
