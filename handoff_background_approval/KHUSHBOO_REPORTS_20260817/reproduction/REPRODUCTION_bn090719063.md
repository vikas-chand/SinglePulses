# bn090719063 — reproduction record
...
```
python scripts/41c_paper_sed.py --trig bn090719063 --bin 0 --model BAND --out results/convention_check/sed_grid_bn090719063 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090719063 --bin 0 --model BANDBB --out results/convention_check/sed_grid_bn090719063 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090719063 --bin 0 --model BANDBBCPL --out results/convention_check/sed_grid_bn090719063 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090719063 --bin 0 --model BANDBBPL --out results/convention_check/sed_grid_bn090719063 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090719063 --bin 0 --model BANDCPL --out results/convention_check/sed_grid_bn090719063 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090719063 --bin 0 --model BANDCUT --out results/convention_check/sed_grid_bn090719063 --fit-root results/convention_check
# … 258 more (one per model/bin panel; same form)
python3 scripts/41e_sed_montage.py --trig bn090719063
python dev/rebuild_step9_canonical.py --trig bn090719063
python3 dev/gen_param_tables.py --trig bn090719063
python scripts/10_spectral_fit_burst.py --trigger bn090719063 --include-bgo --no-log --models highe \
    --blocks-file results/sweep106/bn090719063/blocks/bb_blocks_spectral_bn090719063.ecsv \
    --bkg-file results/background_intervals.ecsv --out-dir results/campaign20_fam/bn090719063_highe
```
...
|---|---|---|---|---|
| n7 | (-29.50, -10.00) | (38.00, 132.44) | (-0.91, 24.00) | Vikas Chand |
| n8 | (-29.50, -10.00) | (38.00, 132.44) | (-0.91, 24.00) | Vikas Chand |
| b1 | (-29.50, -10.00) | (38.00, 132.44) | (-0.91, 24.00) | Vikas Chand |

Block table: `results/sweep106/bn090719063/blocks/bb_blocks_spectral_bn090719063.ecsv`
- sha256 `7abe85da1fa453c1…`
- reused unchanged from the 2026-08-12 binning run; re-deriving blocks
  per convention would break cross-burst comparability.

Canonical fit table: `results/convention_check/bn090719063/spectral_fits.ecsv`
- sha256 `505e6776773697b3…`; 24 models × 11 spectra
- canonicalization: best optimizer minimum per (bin, model) across
  all invocations we possess (multistart luck reaches ΔAIC ≈ 9).

## Notebook

`notebooks/Two_Breaks_single_GRB_pipeline.ipynb` (config `notebooks/configs/bn090719063.yaml`) runs the same chain interactively and
