# bn090809978 — reproduction record
...
```
python scripts/41c_paper_sed.py --trig bn090809978 --bin 0 --model BAND --out results/convention_check/sed_grid_bn090809978 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090809978 --bin 0 --model BANDBB --out results/convention_check/sed_grid_bn090809978 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090809978 --bin 0 --model BANDBBCPL --out results/convention_check/sed_grid_bn090809978 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090809978 --bin 0 --model BANDBBPL --out results/convention_check/sed_grid_bn090809978 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090809978 --bin 0 --model BANDCPL --out results/convention_check/sed_grid_bn090809978 --fit-root results/convention_check
python scripts/41c_paper_sed.py --trig bn090809978 --bin 0 --model BANDCUT --out results/convention_check/sed_grid_bn090809978 --fit-root results/convention_check
# … 233 more (one per model/bin panel; same form)
python3 scripts/41e_sed_montage.py --trig bn090809978
python dev/rebuild_step9_canonical.py --trig bn090809978
python3 dev/gen_param_tables.py --trig bn090809978
python scripts/10_spectral_fit_burst.py --trigger bn090809978 --include-bgo --no-log --models highe \
    --blocks-file results/sweep106/bn090809978/blocks/bb_blocks_spectral_bn090809978.ecsv \
    --bkg-file results/background_intervals.ecsv --out-dir results/campaign20_fam/bn090809978_highe
```
...
|---|---|---|---|---|
| n3 | (-24.76, -7.00) | (25.00, 131.16) | (-0.30, 15.50) | Vikas Chand |
| n4 | (-24.76, -7.00) | (25.00, 131.16) | (-0.30, 15.50) | Vikas Chand |
| n5 | (-24.76, -7.00) | (25.00, 131.16) | (-0.30, 15.50) | Vikas Chand |
| b0 | (-24.76, -7.00) | (25.00, 131.16) | (-0.30, 15.50) | Vikas Chand |

Block table: `results/sweep106/bn090809978/blocks/bb_blocks_spectral_bn090809978.ecsv`
- sha256 `e65e53f7a14ab676…`
- reused unchanged from the 2026-08-12 binning run; re-deriving blocks
  per convention would break cross-burst comparability.

Canonical fit table: `results/convention_check/bn090809978/spectral_fits.ecsv`
- sha256 `12da05d9a8dbb042…`; 24 models × 10 spectra
- canonicalization: best optimizer minimum per (bin, model) across
  all invocations we possess (multistart luck reaches ΔAIC ≈ 9).

## Notebook

`notebooks/Two_Breaks_single_GRB_pipeline.ipynb` (config `notebooks/configs/bn090809978.yaml`) runs the same chain interactively and
